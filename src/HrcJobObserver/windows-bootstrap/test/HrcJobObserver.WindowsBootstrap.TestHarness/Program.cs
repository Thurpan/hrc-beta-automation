...
internal static partial class Program
{
    ...
    private static async Task<int> Main(string[] args)
    {
        ...
        TestCase[] tests =
        {
            ...
            new("native System32 module identity retains exact KERNEL32", TestNativeSystemModuleIdentityRoundTrip),
            new("native System32 module identity owns matching load evidence", TestNativeSystemModuleIdentityEvidence),
            new("native System32 module identity rejects mismatches and bounds work", TestNativeSystemModuleIdentityMismatchAndBounds),
